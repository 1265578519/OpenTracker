...
/* From opentracker.c */
extern size_t g_minimal_population_allowance;
extern size_t g_global_peer_limit;
extern size_t g_global_peer_watermark;
/* From ot_clean.c */
extern volatile size_t g_global_peer_count;
#endif
